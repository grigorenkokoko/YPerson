...
"${yc_cmd[@]}" serverless container revision deploy \
  ...
  --environment "YPERSON_ENV=production,YPERSON_CONFIG_VERSION=${YPERSON_CONFIG_VERSION},YPERSON_PRIVACY_URL=${YPERSON_PRIVACY_URL},YPERSON_SUPPORT_URL=${YPERSON_SUPPORT_URL},YPERSON_ANALYTICS_KILL_SWITCH=false,GRACEFUL_SHUTDOWN_SECONDS=15,YDB_ENDPOINT=${YDB_ENDPOINT},YDB_DATABASE=${YDB_DATABASE},YDB_METADATA_CREDENTIALS=1,YPERSON_OBJECT_BUCKET=${YPERSON_OBJECT_BUCKET},YPERSON_SYNC_ENABLED=true" \
