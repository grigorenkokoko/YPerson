...
- После объединения полный backend-набор завершился с результатом 146 passed; Ruff passed. Чистая Debug-сборка общего iOS-проекта для Generic iOS Simulator без signing завершилась успешно.
